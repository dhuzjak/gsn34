...
public class MobileBatteryLevel extends AbstractVirtualSensor {

	private final transient Logger logger = Logger.getLogger(this.getClass());
	
	private static final String DEFAULT_DEVICE_ID_DELIMITER = "android_id";
	private static final String DEFAULT_DELIMITER = "BATTERY_OK";
	...
	public void dataAvailable(String inputStreamName,
		...
		int ok = Integer.parseInt(data.split(delimiter)[1]);
		
		dataProduced(new StreamElement(outputStructure, new Serializable[] { ok }, streamElement.getTimeStamp()));
	}
}