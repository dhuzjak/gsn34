...
public class WaspCurrBlackAvgHour extends AbstractVirtualSensor{
	...
	private long TIMEBLOCK = 60 * 60 * 1000;				// 60 minuta
    ...
    private static final transient Logger logger = Logger.getLogger(WaspCurrBlackAvgHour.class);
			...
			if(fieldNames[i].equals(dataFieldName.toUpperCase())) {
				...
				//isteklo vrijeme
					...
					StreamElement out = new StreamElement(
								new DataField[] {new DataField("powerAvgHour", "double", "PowerAvgHour")},	
