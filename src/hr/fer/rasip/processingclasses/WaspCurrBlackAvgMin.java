...
public class WaspCurrBlackAvgMin extends AbstractVirtualSensor{
	...
	private long TIMEBLOCK = 60 * 1000;				// 60 sekundi
    ...
    private static final transient Logger logger = Logger.getLogger(WaspCurrBlackAvgMin.class);
			...
			if(fieldNames[i].equals(dataFieldName.toUpperCase())) {
				...
				//isteklo vrijeme
					...
					StreamElement out = new StreamElement(
								new DataField[] {new DataField("powerAvgMin", "double", "PowerAvgMin")},	
